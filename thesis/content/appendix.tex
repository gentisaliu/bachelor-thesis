...
The following tables list the variables, that best correlate with the labeled output. They were determined using the various feature selection algorithms introduced in Section \ref{sec:ch-5-input-vars}. They may possess potentially good discrimination abilities that may result in a good classifier.
