...
\begin{figure}
\hfill
\subfigure[]{\includegraphics[width=3cm]{chapter_6_selection/Feynman/tt_gg_s.pdf}}
\hfill
\subfigure[]{\includegraphics[width=3cm]{chapter_6_selection/Feynman/tt_gg_t.pdf}}
\hfill
\subfigure[]{\includegraphics[width=3cm]{chapter_6_selection/Feynman/tt_gg_u.pdf}}
\hfill
\subfigure[]{\includegraphics[width=3cm]{chapter_6_selection/Feynman/tt_qq_s.pdf}}
\hfill
...
\begin{figure}[!ht]
   \begin{minipage}{\textwidth}
     \centering
     \subfigure[]{\includegraphics[width=7cm]{chapter_6_selection/semilep_pt.png}}\quad
     \subfigure[]{\includegraphics[width=7cm]{chapter_6_selection/semilep_eta.png}}\\
     \subfigure[]{\includegraphics[width=7cm]{chapter_6_selection/semilep_mwt.png}}\quad
     \subfigure[]{\includegraphics[width=7cm]{chapter_6_selection/semilep_ptmiss.png}}
...
\begin{figure}[!ht]
   \begin{minipage}{\textwidth}
     \centering
     \subfigure[]{\includegraphics[width=7cm]{chapter_6_selection/dilep_ll_pt.png}}\quad
     \subfigure[]{\includegraphics[width=7cm]{chapter_6_selection/dilep_ll_eta.png}}\\
     \subfigure[]{\includegraphics[width=7cm]{chapter_6_selection/dilep_tl_pt.png}}\quad
     \subfigure[]{\includegraphics[width=7cm]{chapter_6_selection/dilep_tl_eta.png}}\\
     \subfigure[]{\includegraphics[width=7cm]{chapter_6_selection/dilep_njets.png}}
